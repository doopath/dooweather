...
# (str) Package name
package.name = dooweather

# (str) Package domain (needed for android/ios packaging)
package.domain = org.doopath

# (str) Source code where the main.py live
source.dir = ./dooweather/
...
presplash.filename = %(source.dir)s/../images/dooweather_loading_screen.png

# (str) Icon of the application
icon.filename = %(source.dir)s/../images/weather_icon.png
...
icon.adaptive_foreground.filename = %(source.dir)s/../images/weather_icon.png
icon.adaptive_background.filename = %(source.dir)s/../images/weather_icon.png
...
android.ouya.icon.filename = %(source.dir)s/../images/weather_icon.png
